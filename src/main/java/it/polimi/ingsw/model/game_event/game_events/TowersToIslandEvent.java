...
public class TowersToIslandEvent extends GsonablePrototype implements GameEvent {
    private final TowerEnum tower;
    private final String playerID;
    private final Integer island;

    public TowersToIslandEvent(TowerEnum tower, String playerID, Integer island) {
        this.tower = tower;
    ...
    public void visit(GameEventHandler eventHandler) {
        eventHandler.towersToIsland(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        TowersToIslandEvent that = (TowersToIslandEvent) o;
