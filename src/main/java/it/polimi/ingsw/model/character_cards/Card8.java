...
public class Card8 extends CharacterCard {
    ...
    public void playCard(Board board, String playerID, TokenEnum toActivate, int islandIndex, TokenCollection tokensToAdd, TokenCollection tokensToRemove) throws ReloadGameException {
        ...
        board.getInfluenceHandler().addBonus(playerID, 2);
        ...
        board.notifyObservers(new CCActivatedEvent(this.getCardName(), playerID +  "gets 2 more influence points this turn, we love nepotism :)"));
    }
    ...
    public boolean equals(Object o) {
        ...
        Card8 card8 = (Card8) o;
        return Objects.equals(classname, card8.classname);
    }
    ...
    public void fillDTO(GameDTO gameDTO) {
        ...
        simpleCard.setEffect("you gain 2 additional influence points");
